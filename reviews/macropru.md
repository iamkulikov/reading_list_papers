...
### ["Итоги десятилетия 2008-2017 годов в российском банковском секторе: тенденции и факторы"](https://www.cbr.ru/Content/Document/File/43933/wps31.pdf)

Обзор периодов макропруденциальной политики: борьба с последствиями притока капитала (2007-2008), предотвращение пузыря потребительского кредитования (2013-2014), снижение валютизации балансов (2015-2017), предотвращение пузыря на рынке ипотеки (2017-2018).
...
https://www.imf.org/external/pubs/ft/wp/2015/wp15123.pdf
https://www.sciencedirect.com/science/article/abs/pii/S1042957319300361
https://www.sciencedirect.com/science/article/abs/pii/S1566014122001108
https://www.sciencedirect.com/science/article/pii/S0014292122002306
...
**Описание системных финансовых кризисов в Армении, Азербайджане, Грузии, Казахстане, Кыргызстане, Таджикистане и Узбекистане** в самом конце. Хороший график о внешнем финансировании банков по BOP (только портфельные и other инвестиции) - переворот в отрицательную зону для Казахстана в 2008 году и наибольшие кредитные разрывы, как в плюс, так и в минус. Сколько стран с такой же картиной? Хорошая сравнительная таблица 3 по минимальным регуляторным требованиям: базовый без буферов (8% - Б3), контрциклический буфер (0-2,5%), conservation buffer (2,5%), буфер системной значимости (1-2,5%), прочее включая Pillar 2.
...
Классификация инструментов БР на циклические и струтктурные. Количественные триггеры для введения макропруденциальных лимитов.
...
Нефинансовые компании с показателем ICR менее 1,5 характеризуются повышенной вероятностью дефолта. Для оценки потерь по кредитам таким компаниям применяется PD, равное 15%, которое оценено международным рейтинговым агентством Moody's по данным за период с 1970 по 2012 г.
...
Мотивирующая речь. Принципы:

1.  **Защитить финансовую систему от реальной экономики, чтобы защитить экономику от финансовой системы**. Our interventions to strengthen the system have to be expected to support the real economy more in the bad times than they hold it back in the good. Building a system that could absorb all shocks would be counterproductive (аналогия с ограничением скорости в 20 км/ч).

2.  **Опора на стресс-тесты**.

3.  **Финансовая истема - это не просто совокупность частей, сококупность связей важна**. At the next level are the feedback loops that link seemingly unrelated entities in the system. These are loops created by firesales of assets into illiquid markets, driving down market prices, forcing others to mark down the value of their holdings. This was revealed during the crisis where some investors -- typically 'shadow banks', which took bank-like risks but without being subject to commensurate regulatory standards -- funded their investment in long-term securitised assets with short-term asset-backed commercial paper. When this funding was withdrawn during the crisis, it resulted in a sell-off of these long-term assets, depressing their price. This type of loop will be most aggressive when the fire-seller is funded through short-term debt. As asset prices fall, there is the threat of needing to repay that debt. В конечном итоге, это значит, что надо двигаться в сторону расширения покрытия компаний и рынков макропруденциальной политикой.

4.  **Предотвращать лучше, чем справляться с последствиями**. Building resilience into the financial system solely using bank capital is equivalent to addressing road safety only with tougher car safety standards -- more airbags -- while ignoring standards of driving behaviour. Использовать лучше весь набор мер по чуть-чуть, чем одну, но много - в этом есть элемент страхования.

5.  **Нужна решительность и истинная контрцикличность**. And if we are successful in ensuring the system is resilient, there will be no way of showing the benefits of our actions. We will appear to have been tilting at windmills. As the memory of the financial crisis fades in the public conscience, making the case for our actions will get harder. A truly countercyclical approach means banks, for example, know their capital buffers can be depleted as they take impairments. Households can be confident that our rules won't choke off the refinancing of their mortgage. And insurance companies know their solvency won't be judged at prices in highly illiquid markets.
...
**Полезные факты**: Ипотека - проблема богатых стран, в EM-ах занимаются необеспеченным потребкредитами. Табличка с показателями - триггерами макропруденциальных мер.

### ["Elements of Effective Macroprudential Policies. Lessons from International Experience", IMF-FSB-BIS](https://www.imf.org/external/np/g20/pdf/2016/083116.pdf)

Обзорный текст обо всех аспектах макропруденциальной политики и сведенным опытом к 2016 году. Много ссылок.

### ["Macroprudential Policy and the Financial Cycle: Some Stylized Facts and Policy Suggestions"](https://www.imf.org/external/np/seminars/eng/2013/macro2/pdf/cb.pdf)

Хорошое простое описание сути финансового цикла и того, что макропруденциальная политика должна избежать.
